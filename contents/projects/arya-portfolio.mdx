...
This is my personal website built from scratch since **February 2026** using modern technologies like **Next.js** and **TypeScript**.
...
```bash
npx create-next-app -e https://github.com/arzss-code/arya-portfolio your-app-name
```

```bash
npx degit arzss-code/arya-portfolio your-app-name
```
...
🧠 Made with curiosity, love, and caffeine ☕ by [Atsiila Arya Nabiih](https://github.com/arzss-code)
